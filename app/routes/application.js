...
export default Ember.Route.extend({
  ...
  setupController: function(controller, model) {
    ...
    } else if(windowWidth > controller.get('xtrSmallBreak') && windowWidth <= controller.get('smallBreak')){
      controller.set('breakPointName', 'Small');
      controller.set('isSmall', true);
    } else if(windowWidth > controller.get('smallBreak') && windowWidth <= controller.get('mediumBreak')){
